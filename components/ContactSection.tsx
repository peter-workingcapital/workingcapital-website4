...
import { Phone, Mail, Calendar, CheckCircle, Send, User, Building } from 'lucide-react'
...
const ContactSection = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (!window.grecaptcha) {
        throw new Error('Security verification not loaded. Please refresh the page and try again.')
      }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to stop losing time to HR chaos? Let's discuss how WorkingCapital can help you scale your team and focus on building your product.
          </p>
        </motion.div>
          ...
          >
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    Tell Us About Your HR Challenges (Optional)
                  </label>
                  <textarea
                    {...register('message')}
                    rows={4}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    placeholder="e.g., Hiring takes too long, need help with handbooks, compliance concerns..."
                  />
                </div>
                ...
                <p className="text-sm text-gray-500 text-center">
                  Free 30-minute consultation • No obligation • Custom recommendations
                </p>
              </form>
            )}
          </motion.div>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 text-white">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4" />
                  <span className="text-sm">Proven results with 50+ startups</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4" />
